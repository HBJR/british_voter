...
infile = Path(__file__).parent / 'model_outputs' / 'encoder'
x_encoder = pickle.load(open(infile, 'rb'))

infile = Path(__file__).parent / 'model_outputs' / 'poly'
polynomial = pickle.load(open(infile, 'rb'))

infile = Path(__file__).parent / 'model_outputs' / 'british_voter'
